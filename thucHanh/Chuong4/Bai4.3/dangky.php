...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Lưu vào session (mô phỏng lưu database)
    ...
    // Lưu sở thích màu vào cookie (100 ngày)
    setcookie("remember", "dkemail=$email&dksothich=$sothich", time() + 3600 * 24 * 100, "/");
            ...
            <div class="content">
                ...
                <form method="post">
                    ...
                    <div>
                        ...
                        <input type="radio" name="gioitinh" value="Nữ" required> Nữ</div>
                    <div>
                        <label>Sở thích (Chọn màu nền header):</label>
                        <input type="checkbox" name="sothich" value="bg_green"> Màu xanh
                        <input type="checkbox" name="sothich" value="bg_red"> Màu đỏ
